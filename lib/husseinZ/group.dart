    ...
    return SingleChildScrollView(
      child: Container(
          ...
          SingleChildScrollView(
            ...
            Text("Gambol world",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,letterSpacing: 1),)
              ...
              children: <Widget>[
                ...
                SizedBox(height: 5,),
            Text("Crazy world",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,letterSpacing: 1),)
              ],
               ),
                ),
              ),
                ...
                child: Container(
                  height: 80,
                      ...
                      fontSize: 18   
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text("Darwen , Gambol's brother in a cartoon showd in tv "),
                        )
                      ],
                        ),
                ),
        ...
        ListTile(
          ...
          title: Row(
            children: <Widget>[
              Text("GAMBOL",style: TextStyle(fontWeight: FontWeight.bold),),
              Icon(Icons.play_arrow),
              Text("JEFRRY",style: TextStyle(fontWeight: FontWeight.bold),),
            ],
          ),
